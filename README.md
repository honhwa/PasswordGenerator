...
Password Display Area (Top) - Shows generated password
Settings Area (Middle) - Password rules and length
History Area (Bottom) - List of saved passwords
2.2 Visual Design
Color Palette:
...
Adjust length via slider or numeric input
Toggle character type checkboxes
Click "生成密码" to create new password
Click "复制" to copy current password
Click "保存" to save current password to history
Double-click history item to copy
Select and delete history items
3.3 Edge Cases
